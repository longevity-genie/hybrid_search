...
setup(
    ...
    install_requires=['pycomfort>=0.0.15', 'peft', 'triton' 'click','transformers>=4.35.2', "sentence_transformers", "opensearch-py>=2.6.0", "langchain>=0.2.13", "langchain-community>=0.2.12", "langchain-huggingface>=0.0.3"],
